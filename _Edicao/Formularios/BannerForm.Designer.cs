namespace AppDeckAssistant
{
    partial class BannerForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnUpdate = new AppDeckAssistant.CustomButton();
            ...
            this.btnBottomRight = new AppDeckAssistant.CustomButton();
            this.btnBottom = new AppDeckAssistant.CustomButton();
            this.btnBottomLeft = new AppDeckAssistant.CustomButton();
            this.btnRight = new AppDeckAssistant.CustomButton();
            this.btnMiddle = new AppDeckAssistant.CustomButton();
            this.btnLeft = new AppDeckAssistant.CustomButton();
            this.btnTopRight = new AppDeckAssistant.CustomButton();
            this.btnTop = new AppDeckAssistant.CustomButton();
            this.btnTopLeft = new AppDeckAssistant.CustomButton();
            this.lytConfirm = new System.Windows.Forms.TableLayoutPanel();
            this.btnConfirm = new AppDeckAssistant.CustomButton();
