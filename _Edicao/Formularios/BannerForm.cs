...
namespace AppDeckAssistant
{
    ...
    public partial class BannerForm : MetroFramework.Forms.MetroForm
    {
        ...
        private Color HeaderBackColor, ThemeBackColor, ThemeForeColor, StyleForeColor;
        ...
        private Dictionary<string, string> jogosSteam = new Dictionary<string, string>
    {
        ...
        public BannerForm(string getCaminhoArquivoAtual, string getJogoID, int getPosicaoJogo, string getImagemSelecionada, bool getIsSteam)
        {
            ...
            if (isSteam && !string.IsNullOrEmpty(jogoId))
            {
                ...
                if (File.Exists(caminhoImagem))
                {
                    ...
                    File.Copy(caminhoImagem, caminhoTempPreview, true);
        ...
        private void DestacarBotao(CustomButton button)
        {
            ...
            button.ButtonForeColor = StyleForeColor;
            button.ButtonBorderColor = StyleForeColor;
        ...
        private void btnUpdate_MouseDown(object sender, MouseEventArgs e)
        {
            if (isSteam)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Please, select a valid ID.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        return;
                    }
            ...
            else
            {
                try
                {
                    ...
                    openFileDialog.Title = "Choose a image";
        ...
        private string BaixarImagemPorId()
        {
            ...
            {
                MessageBox.Show($"Error downloding game image {jogoId}: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return null;
            }
        }
        ...
        private string SalvarImagemSelecionada()
        {
            ...
            {
                MessageBox.Show($"Error saving selected image: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return null;
            }
        }
        ...
        private void btnConfirm_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show($"Banner updated with sucess!",
                            "Sucess",
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"Error when confirming update: {ex.Message}", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
            }
        }
