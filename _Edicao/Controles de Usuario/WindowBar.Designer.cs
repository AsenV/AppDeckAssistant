namespace AppDeckAssistant
{
    partial class WindowBar
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.minimizeButton = new AppDeckAssistant.CustomButton();
            this.closeButton = new AppDeckAssistant.CustomButton();
            this.maximizeRestoreButton = new AppDeckAssistant.CustomButton();
